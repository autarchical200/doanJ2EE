...
<body>
	...
	<div class="container mt-5">
		...
		<h3 class="fw-bold mt-4 d-flex justify-content-end">
			Tổng số tiền:
			<span class="text-danger"><%=totalAmount%>đ</span>
		</h3>
			...
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content">
					...
					<div class="modal-body">
						<div class="mb-3">
							<label for="nameInput" class="form-label">Họ và Tên Người
								Nhận</label> <input type="text" class="form-control" id="nameInput"
								name="user_name" placeholder="Nhập Tên" required>
						</div>
						<div class="mb-3">
							<label for="emailInput" class="form-label">Nhập địa chỉ
								email:</label> <input type="email" class="form-control" id="emailInput"
    ...
    sendInvoiceForm.addEventListener("submit", showSuccessMessage);
</script>
</body>
</html>
