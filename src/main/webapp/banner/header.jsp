			...
			<div class="navbar align-items-center justify-content-between">
				...
				<div class="navbar__cart align-items-center  flex-column ">
					<a href="<%=headerBasePath%>/cart.php"><i
						class="bi bi-cart-fill"></i></a> <a
						href="<%=headerBasePath%>/cart.php">Giỏ hàng</a> <span
						class="cart-quantity-counter" id="count_shopping_cart_store">
						0 </span>
				</div>

				<div class="navbar__search-form">
					<form class="input-group"
						action="<%=headerBasePath%>/resultSearch.php" method="GET">
